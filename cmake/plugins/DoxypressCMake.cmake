...
function(_plugin_DoxypressCMake_init)
    ...
    message(STATUS "!!! 1. _plugin_DoxypressCMake_init()")
    if (DEFINED DoxypressCMake_SOURCE_DIR)
        message(STATUS "!!! 2. include(${DoxypressCMake_SOURCE_DIR}/cmake/FindDoxypressCMake.cmake)")
        include(${DoxypressCMake_SOURCE_DIR}/cmake/FindDoxypressCMake.cmake)
    else()
        message(STATUS "!!! 3. find_package(DoxypressCMake REQUIRED)")
