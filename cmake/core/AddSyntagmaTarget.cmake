...
macro(calm_add_library _name)
    if (INTERFACE STREQUAL "${ARGV1}")
        ...
        message(STATUS "_calm_add_target(${_name} LIB ${ARGN})")
...
function(_calm_add_target _target _type)
    ...
    if (DEFINED ARG_DEPENDENCIES)
        message(STATUS "The target ${_target} will link to ${ARG_DEPENDENCIES}")
...
function(_calm_add_dependencies _target)
    if (${ARGC} GREATER 0)
        ...
        if (${_type} STREQUAL INTERFACE_LIBRARY)
            ...
            message(STATUS "The target ${_target} links to ${_targets}")
